...
S_Target=dataset['Target Success']
S_Target=S_Target.astype('category')
S_Target=pd.DataFrame(S_Target)

S_Eng=dataset['EnglishMovies']
...
CleanedX=pd.concat([CleanedX,D_Adult,D_Collection,
                    D_Genre1,D_Genre2,D_Genre3,D_Genre4,D_Genre5,
                    D_Genre6,D_Genre7,D_Genre8,S_Eng,
...
num.to_csv('CleanedNumericTest.csv')
